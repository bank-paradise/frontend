...
export default function DontHaveCommunity() {
  ...
  return (
    <div className="h-[calc(100vh-73px)] w-full flex jusitfy-center items-center">
      {!isOpen ? (
        <PrimaryCard className="max-w-lg m-auto w-full flex flex-col items-center h-max justify-center py-10 px-5 bg-gray-100 rounded-md">
          <SubTitle>Bienvenue</SubTitle>
          <Invitations invitations={invitations} />
          <div className="flex w-full items-center gap-4 px-10 pb-4">
        ...
        <PrimaryCard className="max-w-lg relative m-auto w-full flex flex-col items-center h-max justify-center py-10 px-5 bg-gray-100 rounded-md">
          <button
            className="absolute top-5 left-10 flex items-center text-ms"
